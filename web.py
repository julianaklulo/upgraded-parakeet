...
def marketplace():
    ...
    categories = [category for category in request.args.keys() if category != 'marketplace_name']
    add_marketplace(marketplace_name, categories)
    return render_template('success_message.html', message="Marketplace created successfully!")
